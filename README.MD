...
- [ ] binary files support (images). Each item will have .meta file next to it. For images it should contain desctiption of image content for non-multimodal LLM models.
