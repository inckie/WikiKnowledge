...
> Request → [[src:wikiknowledge/fastapi-backend|FastAPI Router]] → [[src:wikiknowledge/ai-service-architecture|Service Layer]] → [[src:wikiknowledge/storage-abstraction|Storage Backend]] → Filesystem
